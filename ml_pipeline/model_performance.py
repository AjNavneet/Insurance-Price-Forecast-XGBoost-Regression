...
# Calculate the percentage of predictions within a specified residual range
def calc_preds_in_residual_range(y_true, y_pred, range_):
    residuals = abs(y_true - y_pred)
    return 100 * (residuals <= range_).mean()

# Calculate the percentage of predictions within a specified percentage residual range
