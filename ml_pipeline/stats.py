...
# Calculate chi-squared statistic for categorical feature interactions
def chi2(X, correction=True):
    ...
    for col1, col2 in col_pairs:
        ...
        # Calculate chi-squared statistic and related values
...
# Perform analysis of variance (ANOVA) for numeric and categorical feature combinations
def anova(X):
